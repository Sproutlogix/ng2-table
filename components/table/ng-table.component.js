...
var NgTableComponent = (function () {
    ...
    NgTableComponent.prototype.buttonClick = function (row, button) {
        //console.log('Clicked a button for row: ', row.id, button);
    this.cellClicked.emit({ row: row, button: button});
    };
    NgTableComponent.decorators = [
        { type: core_1.Component, args: [{
                    selector: 'ng-table',
                    template: "\n    <table class=\"table dataTable\" ngClass=\"{{config.className || ''}}\"\n           role=\"grid\" style=\"width: 100%;\">\n      <thead>\n        <tr role=\"row\">\n          <th *ngFor=\"let column of columns\" [ngTableSorting]=\"config\" [column]=\"column\" \n              (sortChanged)=\"onChangeTable($event)\" ngClass=\"{{column.className || ''}}\">\n            {{column.title}}\n            <i *ngIf=\"config && column.sort\" class=\"pull-right fa\"\n              [ngClass]=\"{'fa-chevron-down': column.sort === 'desc', 'fa-chevron-up': column.sort === 'asc'}\"></i>\n          </th>\n <th></th>       </tr>\n      </thead>\n      <tbody>\n      <tr *ngIf=\"showFilterRow\">\n        <td *ngFor=\"let column of columns\">\n          <input *ngIf=\"column.filtering\" placeholder=\"{{column.filtering.placeholder}}\"\n                 [ngTableFiltering]=\"column.filtering\"\n                 class=\"form-control\"\n                 style=\"width: auto;\"\n                 (tableChanged)=\"onChangeTable(config)\"/>\n        </td>\n  <td></td>    </tr>\n        <tr *ngFor=\"let row of rows\">\n          <td (click)=\"cellClick(row, column.name)\" *ngFor=\"let column of columns\" [innerHtml]=\"sanitize(getData(row, column.name))\"></td>\n   <td><div *ngIf=\"!row.first_login_on\" class=\"dropdown\"> <button class=\"btn \" type=\"button\" data-toggle=\"dropdown\"><i class=\"ion-android-more-vertical\"></i><span class=\"caret\"></span></button> <ul class=\"dropdown-menu dropdown-menu-right\"> <li class=\"clickable\" (click)=\"buttonClick(row, 'resend')\"><a>Resend Password</a></li> <li class=\"clickable\" (click)=\"buttonClick(row, 'cancel')\"><a>Cancel Invite</a></li> </ul> </div> <div *ngIf=\"row.first_login_on\" class=\"dropdown\"> <button class=\"btn \" type=\"button\" data-toggle=\"dropdown\"><i class=\"ion-android-more-vertical\"></i><span class=\"caret\"></span></button> <ul class=\"dropdown-menu dropdown-menu-right\"> <li class=\"clickable\" *ngIf=\"row.is_enabled\" (click)=\"buttonClick(row, 'block')\"><a>Block user</a></li><li class=\"clickable\" *ngIf=\"!row.is_enabled\" (click)=\"buttonClick(row, 'unblock')\"><a>Unblock user</a></li>  </ul> </div></td>   </tr>\n      </tbody>\n    </table>\n  "
                },] },
    ];
    /** @nocollapse */
